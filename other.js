String.prototype.reverse = function(){ return this.split("").reverse().join(""); }; //who cares about efficiency when you have elegance?
...
//jQuery yay
if($){
    $.fn.check = function(bool){$(this).prop('checked', bool);};
    $.fn.toggleCheck = function(){ $(this).check( !$(this).is(':checked') ); };
    $.fn.reverse = [].reverse;
